...
const MonitorTehuacan = () => {
    ...
    return (
        <div>
            <TemplateMonitoreo region={3} farms={farms} nochesFarmId={nochesFarmId} lastFarmVisited = {farmVisitedByUser} farmId ={ farmId} granjas={tehuacan} titulo={'Tehuacan'} nombreTabla={'tablatehuacan'} />
        </div>
    )
}
