    ...
    return (
        <div className="col-lg-10 mx-auto pt-5 ">
            ...
            <div className="col-lg-12 d-flex justify-content-center">
                ...
                <p className="text-justify">*No ingresa ninguna unidad a granja sin TICKET de lavado y desinfección (Deben ser desinfectadas en granja antes y después de ingresar)</p>
                <p className="text-justify">*Mantenimiento, se fijará 1 a 2 personas por sitio (no se moverán de granja a granja)</p>
                <p className="text-justify">*Organizar viajes de alimento para final del día</p>
                </div>
            </div>
        </div>
    )
...
export default Aciones_Preventivas
