...
const MonitorCordoba = () => {
    ...
    return (
        <div>
            <TemplateMonitoreo region={4} farms={farms} nochesFarmId={nochesFarmId} lastFarmVisited = {farmVisitedByUser} farmId ={ farmId} granjas={cordoba} titulo={'Cordoba'} nombreTabla={'tablacordoba'} />
        </div>
    )
}
